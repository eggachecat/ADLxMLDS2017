...
from keras.layers import BatchNormalization, Dense, Dropout, Masking, LSTM
...
def train_lstm_model(data_getter="get_data_mfcc", max_len=777):
    ...
    mlp.train(model, x_train, y_train, x_valid, y_valid, x_valid, y_valid, batch_size=32, max_len=max_len)
